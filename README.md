...
2. Build the bookmarklet URL, substituting your app's base URL and the token you just generated:
   ...
   ```
   javascript:(function(){var m=document.cookie.match(/(?:^|; )SAPISID=([^;]+)/);if(!m){alert('Not signed into Google in this tab.');return;}var f=document.createElement('form');f.method='POST';f.action='https://YOUR-APP-BASE-URL/admin/sapisid-relay';f.target='_blank';var i1=document.createElement('input');i1.name='sapisid';i1.value=decodeURIComponent(m[1]);f.appendChild(i1);var i2=document.createElement('input');i2.name='token';i2.value='YOUR-TOKEN';f.appendChild(i2);document.body.appendChild(f);f.submit();})();
   ```
...
2. Open the bookmark. A new tab shows "Reconnected." on success.
